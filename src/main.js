 ...
 */
const parsedCSV = parseData('./multilingual_mobile_app_reviews_2025.csv');
 ...
 */
const cleanedCSV = cleanData(parsedCSV);
 ...
 */
// console.log(sentimentAnalysisApp(cleanedCSV));
// console.log(sentimentAnalysisLang(cleanedCSV));

/**
 * Step 4: Statistical Analysis
 *      Call the printAnalysis function to get some summary statistics of the cleaned data.
 */
console.log(summaryStatistics(cleanedCSV));
